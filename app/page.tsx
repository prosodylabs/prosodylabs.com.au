...
const PRICING_TIERS = [
  {
    name: "BYO GPU",
    price: "Free",
    description: "Bring your own hardware. We provide the platform.",
    features: [
      "Connect your own GPU",
  ...
  },
  {
    name: "Credit packs",
    price: "From $10",
    description: "Pay-as-you-go GPU compute. No commitment.",
    features: [
  ...
  },
  {
    name: "Research",
    price: "Custom",
    description: "Dedicated capacity for labs and institutions.",
    features: [
  ...
  return (
    <>
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
        {/* Kairos visualization background */}
        <div className="absolute inset-0 bg-background">
          <KairosVisualization />
        </div>

        {/* Gradient overlay — subtle dark center for text readability */}
