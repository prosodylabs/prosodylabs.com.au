...
const PRICING_TIERS = [
  {
    name: "BYO GPU",
    price: "Free",
    description: "Bring your own hardware. We manage it.",
    features: [
  ...
  },
  {
    name: "Pay as you go",
    price: "From $0.20/hr",
    description: "Top up your balance. Use it for anything — training, inference, sessions. Billed in AUD, per-second.",
    features: [
